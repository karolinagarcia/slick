...
df_basic = pd.read_csv('../output_z1_16zones_total/Basic_Characteristics_m25_run=51.csv')
...
j = {'g_Redshift':'first', 'g_Mass_Gas': 'first', 'g_Radius': 'first', 'g_Metallicity': 'first', 'g_SFR': 'first'}
df_gals_aux1 = df_basic.groupby(['Galaxy_ID'], as_index=False).agg(j)

f = {'H2_Mass': 'sum', 'CO10': 'sum', 'H2_lcii': 'sum', 'CO10': 'sum', 'CO21': 'sum', 'CO32': 'sum', 'CO43': 'sum',
            'CO54': 'sum','CI10': 'sum', 'CI21': 'sum', 'CO65': 'sum', 'CO76': 'sum', 'CO87': 'sum',
            'CO98': 'sum', 'OI1': 'sum', 'OI2': 'sum','OI3': 'sum', 'fH2': 'sum'}
